      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 text-center">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-16 items-center justify-items-center">
          ...
          <Link
            ...
            className="group flex flex-col items-center justify-center p-6 rounded-4xl bg-zinc-900/50 border border-gray-800 w-full h-32 hover:border-primary transition-all duration-500 relative overflow-hidden cursor-pointer shadow-[0_0_0_transparent] hover:shadow-glow-cyan"
          >
            <div className="absolute inset-0 bg-linear-to-b from-primary/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
            <svg
              className="h-10 md:h-12 w-auto fill-gray-500 group-hover:fill-primary transition-all duration-300 transform group-hover:scale-110"
              viewBox="0 0 384 512"
              xmlns="http://www.w3.org/2000/svg"
            >
              <path d="M318.7 268.7c-.2-36.7 16.4-64.4 50-84.8-18.8-26.9-47.2-41.7-84.7-44.6-35.5-2.8-74.3 20.7-88.5 20.7-15 0-49.4-19.7-76.4-19.7C63.3 141.2 4 184.8 4 273.5q0 39.3 14.4 81.2c12.8 36.7 59 126.7 107.2 125.2 25.2-.6 43-17.9 75.8-17.9 31.8 0 48.3 17.9 76.4 17.9 48.6-.7 90.4-82.5 102.6-119.3-65.2-30.7-61.7-90-61.7-91.9zm-56.6-164.2c27.3-32.4 24.8-61.9 24-72.5-24.1 1.4-52 16.4-67.9 34.9-17.5 19.8-27.8 44.3-25.6 71.9 26.1 2 49.9-11.4 69.5-34.3z"></path>
            </svg>
            <span className="absolute bottom-3 md:relative md:bottom-auto md:mt-2 text-[10px] md:text-xs text-gray-500 md:text-gray-600 group-hover:text-primary uppercase tracking-wider font-bold opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-all duration-300 transform translate-y-0 md:translate-y-2 md:group-hover:translate-y-0">
              iPhone Series
            </span>
          </Link>
          ...
          <Link
            ...
            className="group flex flex-col items-center justify-center p-6 rounded-4xl bg-zinc-900/50 border border-gray-800 w-full h-32 hover:border-secondary transition-all duration-500 relative overflow-hidden cursor-pointer shadow-[0_0_0_transparent] hover:shadow-glow-red"
          >
            <div className="absolute inset-0 bg-linear-to-b from-secondary/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
            <svg
              className="h-10 md:h-12 w-auto fill-gray-500 group-hover:fill-secondary transition-all duration-300 transform group-hover:scale-110"
            ...
            <span className="absolute bottom-3 md:relative md:bottom-auto md:mt-2 text-[10px] md:text-xs text-gray-500 md:text-gray-600 group-hover:text-secondary uppercase tracking-wider font-bold opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-all duration-300 transform translate-y-0 md:translate-y-2 md:group-hover:translate-y-0">
              Galaxy Series
            </span>
          </Link>
