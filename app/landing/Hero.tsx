            ...
            <div className="relative z-10 w-full max-w-7xl mx-auto px-4 md:px-8 py-12 md:py-16 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="text-left space-y-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 pt-4">
                        ...
                        <Link href="/products" className="p-[2px] rounded-full bg-linear-to-r from-[#5CE1E6] to-[#FF3131] group transition-all duration-300 hover:shadow-[0_0_20px_rgba(255,255,255,0.5)]">
