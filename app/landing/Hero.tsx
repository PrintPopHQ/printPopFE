            ...
            <div className="relative z-10 w-full max-w-7xl mx-auto px-4 md:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="text-left space-y-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 pt-4">
                        ...
                        <Link href="/customize" className="px-8 py-4 btn-brand-gradient text-white font-bold text-base rounded-full shadow-[0_0_20px_rgba(255,49,49,0.5)] hover:shadow-[0_0_30px_rgba(255,49,49,0.8)] transition-all duration-300 text-center uppercase tracking-wider">
                            Customize Yours
                        </Link>
                    </div>
                </div>
