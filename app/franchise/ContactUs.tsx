...
export default function ContactUs() {
  return (
    <div className="max-w-7xl mx-auto px-4 w-full py-0 sm:py-4 md:py-10">
      {/* Mobile Heading - visible only on mobile */}
      <h2 className="lg:hidden text-4xl font-black tracking-widest font-neon mb-12 text-center">
        <span className="text-shadow-[0_0_30px_#FF3131]">CONTACT</span> <span className="text-neon-red">US</span>
      </h2>

      <div className="flex flex-col gap-12 md:gap-16 justify-between items-center lg:flex-row-reverse">
        ...
        {/* Right Info Section */}
        <div className="w-full lg:w-[45%] flex flex-col justify-start lg:pl-8 pt-8 lg:pt-24 mt-4 lg:mt-0 font-montserrat">

          {/* Desktop Heading - visible only on desktop */}
          <h2 className="hidden lg:block text-4xl font-black tracking-widest font-neon mb-6 z-10">
            <span className="text-shadow-[0_0_30px_#FF3131]">CONTACT</span> <span className="text-neon-red">US</span>
          </h2>
