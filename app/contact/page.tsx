...
export default function ContactPage() {
  return (
    <div className="min-h-screen font-sans bg-[#000000]">
      ...
      <div className="max-w-7xl mx-auto px-4 w-full py-12 md:py-24">
        ...
        <div className="flex flex-col lg:flex-row-reverse gap-12 md:gap-16 justify-between items-center">
          {/* Left Form Section */}
