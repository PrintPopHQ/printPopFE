          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              },
              {
                ...
                icon: (
                  <svg className="h-10 w-auto fill-gray-500 group-hover:fill-[#1428a0] transition-all duration-300 transform group-hover:scale-110" viewBox="0 7.2 24 8.8">
              ...
              },
              {
                ...
                borderColor: 'border-white/10 hover:border-[#009241]',
                icon: (
                  <svg
                    className="h-10 w-auto fill-gray-500 group-hover:fill-[#009241] transition-all duration-300 transform group-hover:scale-110"
                    viewBox="0 4 24 16"
