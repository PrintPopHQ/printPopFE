            ...
            {[
              {
                ...
                icon: (
                  <svg className="h-10 w-auto fill-gray-500 group-hover:fill-primary transition-all duration-300 transform group-hover:scale-110" viewBox="0 0 384 512">
              ...
              },
              {
                ...
                icon: (
                  <svg className="h-10 w-auto fill-gray-500 group-hover:fill-secondary transition-all duration-300 transform group-hover:scale-110" viewBox="0 7.2 24 8.8">
              ...
              },
              {
                ...
                textHover: 'group-hover:text-primary',
                icon: (
                  <svg className="h-10 w-auto fill-gray-500 group-hover:fill-primary transition-all duration-300 transform group-hover:scale-110" viewBox="0 0 488 512">
              ...
              },
              {
                ...
                icon: (
                  <svg
                    className="h-10 w-auto fill-gray-500 group-hover:fill-secondary transition-all duration-300 transform group-hover:scale-110"
                    viewBox="0 4 24 16"
              ...
              <div
                ...
                className={cn(
                  "group flex flex-col items-center justify-center sm:p-4 p-8 rounded-[2.5rem] bg-zinc-900/50 border border-white/10 h-40 transition-all duration-500 relative overflow-hidden cursor-pointer shadow-[0_0_0_transparent]",
                  b.hoverBorder,
                  b.hoverShadow
                )}
              >
                <div className={cn("absolute inset-0 bg-linear-to-b to-transparent opacity-0 group-hover:opacity-100 transition-opacity", b.gradient)} />
